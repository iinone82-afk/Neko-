...
export const CatRoomTab: React.FC<CatRoomTabProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col px-4 sm:px-6 py-4 max-w-4xl mx-auto w-full select-none overflow-y-auto">
      {/* Cat Room Header with Editable Name */}
      <div className="flex items-center justify-between bg-white/90 rounded-2xl p-4 border border-orange-100 shadow-xs mb-4">
