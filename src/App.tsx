...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-amber-50/40 text-stone-800 font-['Nunito',sans-serif] selection:bg-orange-200 selection:text-orange-900">
      {/* Coin Reward Banner */}
      <CoinRewardBanner
      ...
      {/* Responsive Website Top Navigation Bar */}
      <WebNavbar
        activeTab={activeTab}
        onSelectTab={(tab) => {
          playClickSound(soundEnabled);
      ...
      <main className="flex-1 flex flex-col w-full py-4 sm:py-6">
        {activeTab === 'timer' && (
          <TimerTab
